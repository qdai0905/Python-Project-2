...
Looking at the figures in detail, the chart highlights many user interests and suggests that content creators may focus on varied content types rather than focusing on a single format because audience preferences are spread evenly across multiple content types.
        <div/>
        """,
        unsafe_allow_html=True)
...
# Filter selected feature
     ...
     st.markdown(
       """
       <div style='text-align: justify;'>
       The box plot summarizes Instagram user engagement across several metrics, including demographics, usage patterns, and feature preferences.
...
The chart indicates that average diet quality is the most common across all gender groups, while other categories such as very poor or excellent diets appear less frequently.
        </div>
        """,
        unsafe_allow_html=True)
...
The heatmap suggests that stress levels vary not only by income but also significantly by employment status, with unemployed individuals and students showing greater stress fluctuations compared to other groups.
        </div>
        """,
        unsafe_allow_html=True)
# ===================== ABOUT INSTAGRAM =====================
